...
obj/main.o: src/kernel.c obj/vga.o obj/tty.o obj/ints.o obj/idt.o obj/keyboard.o obj/acpi.o obj/madt.o obj/apic.o obj/heap.o obj/printf.o obj/ipi.o obj/ioapic.o obj/pit.o obj/vmx_init.o obj/vmx_enable.o obj/msr.o obj/gdt.o obj/term.o obj/term_vga.o obj/term_serial_io.o obj/module.o obj/term_serial_mmio.o obj/pic.o
	$(CC) $(CFLAGS) -c src/kernel.c -o obj/main.o -g
...
obj/vmx_enable.o: src/vmx/vmx_enable.c obj/regs.o bin/vm1.bin bin/vm2.bin
...
obj/pic.o: src/pci/pci.c
	$(CC) $(CFLAGS) -c src/pci/pci.c -o obj/pci.o

bin/vm1.bin: src/vm1.asm
	$(AS) src/vm1.asm bin/vm1.bin

bin/vm2.bin: src/vm2.asm
	$(AS) src/vm2.asm bin/vm2.bin
