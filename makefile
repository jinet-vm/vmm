...
obj/main.o: src/kernel.c obj/vga.o obj/tty.o obj/ints.o obj/idt.o obj/keyboard.o obj/acpi.o obj/madt.o obj/apic.o obj/heap.o obj/printf.o obj/ipi.o obj/ioapic.o obj/pit.o obj/vmx_init.o obj/vmx_enable.o obj/msr.o obj/gdt.o obj/term.o obj/term_vga.o obj/term_serial_io.o
	$(CC) $(CFLAGS) -c src/kernel.c -o obj/main.o -g
